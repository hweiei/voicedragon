...
export const SKILL_INDEX = Object.fromEntries(SKILLS.map((skill) => [skill.id, skill]));
...
export const EVENTS = [
  {
    ...
    choices: [
      ...
      { id: "learn", label: "同掌柜倾偈", hint: "获得随机技能，失去 8 两", action: "buySkill", value: 8 }
    ]
  },
  {
    id: "word-wall",
  ...
  },
  {
    ...
    choices: [
      { id: "help", label: "帮手扎狮头", hint: "失去 8 点生命，获得遗物", action: "relicForHp", value: 8 },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "shortcut", label: "抄黑巷近道", hint: "50% 得 30 两；50% 受伤", action: "gamble", value: 30 }
    ]
  }
];
