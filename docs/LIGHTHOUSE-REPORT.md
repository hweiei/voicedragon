...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Mobile（三次默认移动仿真中位数） | **99** | **100** | **100** | **100** | 1419 ms | 1630 ms | 71 ms | 0.000 |
| Desktop | **100** | **100** | **100** | **100** | 370 ms | 424 ms | 0 ms | 0.006 |

游戏本体 JS 最近实测 **87.6 / 350 KB gzip**。Lighthouse v12 已移除 PWA 类目；安装壳改由 44 项构建产物契约与跨浏览器离线测试守护。
